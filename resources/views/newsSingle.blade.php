                       ...
                       {!! $news_detail->news_content !!}
                            ...
                            <div class="author-box">
                                <div class="author-comment">
                                    <div class="inner-box">
                                        <div class="image"><img src="{{asset('uploads/' .$news_detail->admin->image)}}" alt="" /></div>
                            ...
                            <div class="related-posts">
                                ...
                                <div class="related-item-carousel owl-carousel owl-theme">
                                    ...
                                    <div class="news-block-two small-block">
                                        <div class="inner-box">
                                            <div class="image">
                                                <a href="#"><img src="{{asset('uploads/news/'.$data->image)}}" alt="" /></a>
                        ...
                        <script>
                            ...
                            */
                            ...
                            s.src = 'https://news-portal-10.disqus.com/embed.js';
