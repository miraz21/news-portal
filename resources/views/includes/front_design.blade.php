                ...
                <div class="clearfix">
                    ...
                    <div class="top-right pull-right col-md-8 col-sm-12 col-xs-12">
                        ...
                        <ul class="social-nav">
                            ...
                            @endif
                            @if(!empty($social->pinteret))
                                <li><a href="{{$social->pinteret}}" target="_blank"><span class="fa fa-pinterest-p"></span></a></li>
                            @endif
                        </ul>
                    </div>
                </div>
            ...
            <div class="auto-container">
                <div class="clearfix">
                    ...
                    <div class="pull-right upper-right clearfix">
                        <div class="add-image">
                            <a href="#"><img src="{{ asset('images/resource/header-add.jpg') }}" alt="" /></a>
                        </div>
                    </div>
